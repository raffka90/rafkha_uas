...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Form Edit Pedagang</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Form Edit Pedagang</li>
            </ol>
        </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <form method="POST" action="/pedagang/">
            ...
            @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="nama"  value="{{$pedagang->nama}}">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Alamat</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" name="alamat"  value="{{$pedagang->alamat}}">
                </div>
                <div class="form-group">
